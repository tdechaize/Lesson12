# Lesson12
Lesson12 OpenGL (from NeHe)

Vous trouverez dans Le sommaire ci-dessous, toutes les explications concernant cette application utilisant une "display" liste en OpenGL 
(.ie. une liste d'objets affichés à l'écran) sur laquelle s'applique alors les saisies clavier dans leur ensemble. C'est un exemple issu
du site NeHe.
...
Project Description: Display List Tutorial
