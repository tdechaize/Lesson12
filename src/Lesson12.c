...
#include <stdint.h>			// Header File For Standard use of derived integer type (needeed for CLANG + VS2022 + kit Windows)
#endif
...
/**	            This Code Create list of cubes.
*
* \brief      Fonction BuildLists : génére la liste des cubes à dessiner de façon itérative
* \details    Sur chaque cube, la face présentée provient d'un fichier Bitmap
...
int LoadGLTextures()									// Load Bitmaps And Convert To Textures
{
	...
	if (!NeHeLoadBitmap("../../Data/Cube.bmp", texture))		// Load The Bitmap
		return FALSE;
